...
var tableta = document.getElementById("MYTABLE") as HTMLTableElement
var tabletaCliente = document.getElementById("MYTABLE2") as HTMLTableElement
...
var idcliente = document.getElementById("IdClientes")as HTMLInputElement
var imgprod = document.getElementById("ImagenProductos") as HTMLInputElement
...
function loadTable() {
    ...
    var newidprod:unknown =tableta.rows[tableta.rows.length-1].cells[0].innerHTML 

    newidprod =Number(newidprod as number)

    newidprod = (newidprod as number +1)
...
function loadTableCliente() {
    ...
    var newidcliente:unknown =tabletaCliente.rows[tabletaCliente.rows.length-1].cells[0].innerHTML 

    newidcliente =Number(newidcliente as number)

    newidcliente = (newidcliente as number +1)
